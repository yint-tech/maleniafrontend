...
const Form = () => {
  ...
  const CONFIGS = [
    {
      key: "rouge2.global.maxWhiteIpPerUser",
      name: "每个用户最大的白名单数量",
      desc: "数字，建议100",
      component: (
        <SingleInputItem
          placeholder="建议100"
          initKey="rouge2.global.maxWhiteIpPerUser"
          initValue={configs["rouge2.global.maxWhiteIpPerUser"]}
    ...
    },
    {
      ...
      name: "扩展IP解析器",
      desc: "使用 groovy 定义 extension。Demo 见文档，IP资源定义章节",
      component: (
        <SingleInputItem
