          ...
          renderCollapse={(item) => (
            ...
            >
              <Grid item xs={12} >
                ...
                <Typography gutterBottom variant="h6" >
                  按小时计价价格：1小时/{item.hourPrice}元
                </Typography>
                <Typography gutterBottom variant="h6" >
                  按流量计价价格：0.01G/{item.flowPrice}元
                </Typography>
                <Typography gutterBottom variant="h6" >
                  ...
                  {user.isAdmin ? (
                    <>
                      <Button
                        ...
                        color="primary"
                        className={classes.tableButton}
                        onClick={() => history.push('/proxyProductEdit/' + item.productId)}
                        variant="contained">编辑</Button>
                      <Button
                        startIcon={<AccountTreeIcon style={{ fontSize: 16 }} />}
                        size="small"
                        color="primary"
                        className={classes.tableButton}
                        onClick={() => history.push('/productSourceEdit/' + item.productId)}
                        variant="contained">IP资源</Button>
                      <Switch
          ...
          <>
            ...
            >
              <Grid item xs={12} >
                ...
                <Typography gutterBottom variant="h6" >
                  价格：{balanceMethod === 'METHOD_HOUR' ? edit.hourPrice + " RMB" : edit.flowPrice + " RMB"}
                </Typography>
                <Typography gutterBottom variant="h6" >
                  代理 url：{edit.loadUrl}
                </Typography>
